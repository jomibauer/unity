...
public class AbilityMenuPanelController : MonoBehaviour
{
    ...
    //Functions for selecting the next/prior entry in an ability menu.  
    //Using modulus in the loop on the index means the selection will wrap around to the start if you're unable to select any other menu item (e.g. if its locked)
    public void Next ()
    {
